...
export function CTASection({
  ...
  return (
    <Section>
      <Container>
        <div className="relative isolate overflow-hidden rounded-[28px] border border-blue/20 bg-gradient-to-b from-white/[0.05] to-white/[0.01] px-6 py-12 text-center sm:px-16 sm:py-24">
          <Glow
